...
export const LATITUDE_OFFSET : number = 807.35188;

// Scale to translate coordinate system
export const LATITUDE_SCALE : number = -0.00000576766;

// Longitude of the UW Seattle campus
export const UW_LONGITUDE : number = -122.31305164734569;

// Offset to translate coordinate system
export const LONGITUDE_OFFSET : number = 1370.6408;

// Scale to translate coordinate system
export const LONGITUDE_SCALE : number = 0.00000848028;
